...
/*===== DEFINE HOW TO CALCULATE THE SURFACE HEAT FLUXES =====*/
#define ATM2OCN_FLUXES
/*#define ROMS_BULK_FLUXES*/
...
#ifdef ROMS_MODEL /* BEG:: ROMS_MODEL CONFIGURATION */
...
/* (1) ATM2OCN_FLUXES                                                   */
/*    LONGWAVE: WRF exports the downward long wave radiation flux.      */
/*              During the coupling process (file mct_roms_wrf.h)       */
/*              it is also calculated the upward long wave radiation    */
/*              flux. Finally ROMS is receiving the "net long wave      */
/*              radiation flux".                                        */
/*    SHORTWAVE: WRF exports the net short wave radiation flux to ROMS  */
/* (2) BULK_FLUXES                                                      */
/*    In this case in a WRF-ROMS coupling setup, ROMS receives the net  */
/*    long and short wave radiation fluxes. Latent and sensible fluxes  */
/*    are computed in ROMS using Tair, Qair (conversion factor          */
/*    in varinfo.dat for Qair should be set to 1.0d0, because the       */
/*    conversion is already done in mct_roms_wrf.h)                     */
/* (3) ROMS_BULK_FLUXES                                                 */
/*    In this case in a WRF-ROMS coupling setup, ROMS computes all the  */
/*    heat fluxes from the WRF input parameters.                        */
/*======================================================================*/
#  if defined(WRF_MODEL)
#    if defined ATM2OCN_FLUXES
/* (1) WRF calculates/exports all heat fluxes */
#      undef  BULK_FLUXES
#      undef  LONGWAVE_OUT
#      define SOLAR_SOURCE
#      define EMINUSP
...
#      define ANA_BTFLUX
#    else
#      if !defined ROMS_BULK_FLUXES
/* (2) WRF exports only the long/short radiative fluxes */
#        define BULK_FLUXES
#        undef  LONGWAVE_OUT
#        define SOLAR_SOURCE
#        define EMINUSP
...
#        define ANA_BTFLUX
#      else
/* (3) ROMS calculates all heat fluxes from the WRF input variables */
#        define BULK_FLUXES
#        define ANA_SRFLUX
#        define LONGWAVE
#        define ALBEDO
...
#    endif
#  else
#    if defined ROMS_FULL_ANA_FORCING
/* (4) Forcing of ROMS is done only using ANALYTICAL functions only */
#      define BULK_FLUXES
#      define ANA_SRFLUX
#      define LONGWAVE
#      define ALBEDO
...
#      define ANA_WINDS
#    else
/* (5) Forcing of ROMS is done using external data (e.g., CFSR) */
#      define BULK_FLUXES
#      define SOLAR_SOURCE
#      define EMINUSP
#      define LONGWAVE_OUT
...
#endif /* END:: ROMS_MODEL CONFIGURATION */
