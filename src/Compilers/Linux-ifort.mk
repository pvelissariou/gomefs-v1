...
#          FFLAGS += -g -check bounds -traceback
           ...
           FFLAGS += -ip -O3
 ifeq ($(CPU),i686)
# -xW is depreceated as from intel 11.* compilers, use -msse2
#           FFLAGS += -pc80 -xW
#           FFLAGS += -pc80 -msse2
           FFLAGS += -pc80
 endif
...
ifdef USE_JASPER
       JASPER_INCDIR ?= /usr/include/jasper
       JASPER_LIBDIR ?= /usr/lib
endif
...
ifdef USE_JASPER
ifneq ($(wildcard WRF/external/io_grib2/libio_grib2.a),)
             LIBS += WRF/external/io_grib2/libio_grib2.a
             LIBS += -L$(JASPER_LIBDIR) -ljasper
endif
endif
